let stateControls = {
	create: function() {
		...
		let backButton = game.add.button(settings.width / 2 - settings.buttonSize.w / 2, 600, 'button', this.back, this, 0, 1, 2);		
		let startLabel = game.add.bitmapText(settings.width / 2 - 60, 608, 'yggdrasil', 'Back', 46);
