let stateControls = {
	create: function() {
		...
		let skillLabel = game.add.bitmapText(settings.width / 2 - 180, 600, 'yggdrasil', 'LMB: Cast skill', 48);
		let backButton = game.add.button(settings.width / 2 - settings.buttonSize.w / 2, 700, 'button', this.back, this, 0, 1, 2);		
		let backLabel = game.add.bitmapText(settings.width / 2 - 60, 708, 'yggdrasil', 'Back', 46);
